...
//    Так же в обработчике проверяется корректность введенного логина и пароля. Если данные корректны, то после
//    нажатия кнопки логина, открывается новая активити, а текущая закрывается методом finish()
...
//    Метод, который размещает progressBar в активити после нажатия кнопки логина
    private fun addProgressBar (progressBar: ProgressBar) {
